...
while True:
    ...
    if estado == "MENU": 
        ...
        mostrar_texto("ClicQuest",90,titulo,GOLD)
        
        mostrar_texto("Juego de Reacción",170,font_big,WHITE)

        mostrar_texto("Presiona una tecla para elegir rondas",230,font,L_GOLD )
        cuadros = [
        ...
        mostrar_texto("Teclas: 1 - 3 - 5",690, font_big,L_SEA_GREEN)
